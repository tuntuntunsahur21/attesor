...
## 🚀 Getting Started: How to Download attesor
...
3. Under the latest release, find a Windows installer file. It often ends with `.exe`.

4. Click that file name to start downloading.

---

## 💾 Installing attesor on Windows
...
3. Follow the instructions on the screen. Usually, this means clicking "Next" a few times.

4. Choose the folder where you want to install attesor or accept the default location.
...
## 🏃‍♂️ Running attesor for the First Time

Follow these steps to open and start using attesor:

1. Find the attesor shortcut on your desktop or in the Start Menu.

2. Double-click the shortcut to open the program.

3. The program window will appear. You can now begin using attesor.
...
1. **Load a Program:** Click “Open” or “Load” in attesor to select a file you want to analyze. This file should be a Linux program you want to reverse-engineer.

2. **Start Analysis:** press the “Analyze” button. The AI will work to understand the program’s structure. This may take a few minutes.

3. **View Results:** After the analysis finishes, attesor displays a report. This report shows parts of the program and hints about how it works.

4. **Explore Details:** You can click sections of the report to get deeper info. This helps if you want to learn more about specific parts of the software.

---

## 📂 File Support and Formats
